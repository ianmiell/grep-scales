...
''','And this is the last line.')
		...
		shutit.golf('Print the line after the empty line.','63b6f5fd46648742a6f7aacff644dd92',expect_type='md5sum',print_md5=True)
		shutit.golf('Print the two lines before the empty line.','444cc6679be200fc6579678b6afe19e9',expect_type='md5sum',print_md5=True)
