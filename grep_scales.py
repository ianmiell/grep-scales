...
''','And this is the last line.',hints=['last','grep last afile'])
		...
		shutit.golf(afile_message + 'Print the two lines before the empty line.','444cc6679be200fc6579678b6afe19e9',expect_type='md5sum',hints=['-B','-B2','ask again to get answer','grep -B2 ^$ afile'])
